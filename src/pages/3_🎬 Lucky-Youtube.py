...
st.set_page_config(layout="wide", page_icon="💬", page_title="吉祥 | Chat-Bot 🤖")
...
st.markdown(
    f"""
    <h1 style='text-align: center;'> 告诉吉祥 需要总结的 YouTube 视频 ! 😁</h1>
    """,
...
if not user_api_key:
    ...
    video_url = st.text_input(placeholder="请输入 Youtube 视频 URL", label_visibility="hidden", label =" ")
    if video_url :
