...
class Sidebar:
    ...
    @staticmethod
    def about():
        about = st.sidebar.expander("🧠 关于 吉祥 ")
        sections = [
            "#### 吉祥 是一个带有对话记忆的AI聊天机器人，旨在让用户以更直观的方式讨论他们的数据. 📄",
            "#### 它使用大型语言模型为用户提供关于用户数据内容的自然语言交互. 🌐",
    ...
    def show_options(self):
        with st.sidebar.expander("🛠️ Lucky's Tools", expanded=False):
